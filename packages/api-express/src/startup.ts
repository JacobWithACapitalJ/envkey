...
import { ensureEnv, env } from "../api-shared/src/env";
import express from "express";
import initRoutes from "./routes";
import { runMigrationsIfNeeded } from "./migrate";
import { resolveMaxPacketSize } from "../api-shared/src/db";

ensureEnv();

require("../api-shared/src/api_handlers");
require("../api-shared/src/fetch_handlers");
