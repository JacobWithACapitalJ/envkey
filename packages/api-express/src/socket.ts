import { getOrg } from "../api-shared/src/models/orgs";
import * as R from "ramda";
import WebSocket from "ws";
import url from "url";
import { IncomingMessage, createServer } from "http";
import { Auth, Api, Model, Billing } from "@envkey/core/types";
import { log, logStderr } from "@envkey/core/lib/utils/logger";
import { authenticate, getOrgStats } from "../api-shared/src/auth";
import { verifySignedLicense } from "../api-shared/src/billing";
import { okResult } from "./routes/route_helpers";
import { upTo1Sec, wait } from "@envkey/core/lib/utils/wait";
import {
  getDb,
