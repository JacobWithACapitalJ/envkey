...
export declare const getInvitableOrgRoles: ((graph: Graph.Graph, currentUserId: string) => ((({
    id?: string;
    createdAt?: number;
    updatedAt?: number;
    deletedAt?: number;
    ...
    canInviteAllOrgRoles?: undefined;
    canInviteOrgRoleIds?: string[];
})))[]>, getRevokableInvites: ((graph: Graph.Graph, currentUserId: string, now: number) => {
    type?: "invite";
    pubkey?: {
        keys?: {
            signingKey?: string;
    ...
    acceptedAt?: number;
    v1Invite?: boolean;
}[]) & import("memoizee").Memoized<(graph: Graph.Graph, currentUserId: string, now: number) => {
    type?: "invite";
    pubkey?: {
        keys?: {
            signingKey?: string;
