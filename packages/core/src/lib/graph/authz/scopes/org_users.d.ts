...
export declare const getRenameableUsers: ((graph: Graph.Graph, currentUserId: string) => {
    type?: "orgUser";
    email?: string;
    id?: string;
    uid?: string;
    ...
    updatedAt?: number;
    deletedAt?: number;
}[]>, getRoleUpdateableUsers: ((graph: Graph.Graph, currentUserId: string) => {
    type?: "orgUser";
    email?: string;
    id?: string;
    uid?: string;
    ...
    updatedAt?: number;
    deletedAt?: number;
}[]>, getRemoveableUsers: ((graph: Graph.Graph, currentUserId: string) => {
    type?: "orgUser";
    email?: string;
    id?: string;
    uid?: string;
    ...
    updatedAt?: number;
    deletedAt?: number;
}[]>, getOrgRolesAssignableToUser: ((graph: Graph.Graph, currentUserId: string, targetUserId: string) => ((({
    id?: string;
    createdAt?: number;
    updatedAt?: number;
    deletedAt?: number;
...
})))[]) & import("memoizee").Memoized<(graph: Graph.Graph, currentUserId: string, targetUserId: string) => ((({
    id?: string;
    createdAt?: number;
    updatedAt?: number;
    deletedAt?: number;
    ...
    canInviteAllOrgRoles?: undefined;
    canInviteOrgRoleIds?: string[];
})))[]>, getListableOrgUsers: ((graph: Graph.Graph, currentUserId: string) => {
    type?: "orgUser";
    email?: string;
    id?: string;
    uid?: string;
