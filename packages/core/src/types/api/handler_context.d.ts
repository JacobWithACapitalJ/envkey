...
export type HandlerContext = {
    ...
    type: ActionType.CREATE_CLI_USER | ActionType.CREATE_APP | ActionType.CREATE_BLOCK | ActionType.CREATE_VARIABLE_GROUP | ActionType.CREATE_SERVER | ActionType.CREATE_LOCAL_KEY | ActionType.RBAC_CREATE_ORG_ROLE | ActionType.CREATE_ENVIRONMENT | ActionType.RBAC_CREATE_ENVIRONMENT_ROLE | ActionType.RBAC_CREATE_APP_ROLE | ActionType.RBAC_CREATE_INCLUDED_APP_ROLE | ActionType.CREATE_GROUP | ActionType.CREATE_GROUP_MEMBERSHIP | ActionType.CREATE_APP_USER_GROUP | ActionType.CREATE_APP_GROUP_USER_GROUP | ActionType.CREATE_APP_GROUP_USER | ActionType.CREATE_APP_BLOCK_GROUP | ActionType.CREATE_APP_GROUP_BLOCK | ActionType.CREATE_APP_GROUP_BLOCK_GROUP | ActionType.GENERATE_KEY | ActionType.GRANT_APP_ACCESS | ActionType.CONNECT_BLOCK | ActionType.CREATE_RECOVERY_KEY | ActionType.CREATE_ORG_SAML_PROVIDER | ActionType.CREATE_SCIM_PROVISIONING_PROVIDER;
    createdId: string;
} | {
...
//# sourceMappingURL=handler_context.d.ts.map