...
export declare namespace Action {
    type EnvkeyAction = Action.ClientAction | Api.Action.RequestAction;
    type DispatchAction<ActionType extends EnvkeyAction = EnvkeyAction> = ActionType extends Api.Action.RequestAction ? Omit<ActionType, "meta"> & {
        meta?: Partial<ActionType["meta"]>;
    } : ActionType;
    type SuccessAction<ActionType extends EnvkeyAction = EnvkeyAction, SuccessType = any> = {
        type: string;
        meta: {
    ...
    type FailureAction<ActionType extends EnvkeyAction = EnvkeyAction, FailureType = Api.Net.ErrorResult> = {
        type: string;
        meta: {
            rootAction: ActionType;
        };
    ...
    type ReplayableEnvUpdateAction = {
    ...
    type PendingEnvUpdateAction = Omit<ReplayableEnvUpdateAction, "meta"> & {
        meta: Omit<ReplayableEnvUpdateAction["meta"], "pendingAt"> & {
            pendingAt: number;
        };
    };
    type EnvUpdateActions = {
        CreateEntry: {
    ...
    type ClientActions = EnvUpdateActions & {
        Register: {
            type: ActionType.REGISTER;
            payload: Pick<Api.Net.ApiParamTypes["Register"], "user" | "org" | "test"> & {
        ...
        CreateEntryRow: {
            ...
            payload: {
                ...
                entryKey: string;
                vals: {
                    [environmentId: string]: Env.EnvWithMetaCell;
                };
            };
        };
        UpdateEntryRow: {
        ...
        CreateCliUser: {
            ...
            payload: Pick<Api.Net.ApiParamTypes["CreateCliUser"], "name" | "orgRoleId" | "appUserGrants" | "importId">;
        };
        ...
        CreateServer: {
            ...
            payload: Pick<Api.Net.ApiParamTypes["CreateServer"], "appId" | "name" | "environmentId" | "importId"> & {
        ...
        CreateLocalKey: {
            ...
            payload: Pick<Api.Net.ApiParamTypes["CreateLocalKey"], "appId" | "name" | "environmentId" | "autoGenerated" | "importId" | "isV1UpgradeKey" | "userId"> & {
                skipGenerateKey?: boolean;
                v1Payload?: Api.Net.ApiParamTypes["GenerateKey"]["v1Payload"];
                v1EnvkeyIdPart?: string;
                v1EncryptionKey?: string;
        ...
        GenerateKey: {
            ...
            payload: Pick<Api.Net.ApiParamTypes["GenerateKey"], "appId" | "keyableParentId" | "keyableParentType" | "v1Payload"> & {
                v1EnvkeyIdPart?: string;
                v1EncryptionKey?: string;
            };
        };
        ...
        ConnectBlocks: {
            ...
            payload: (Pick<Api.Net.ApiParamTypes["ConnectBlock"], "appId" | "blockId" | "orderIndex" | "importId"> | Pick<Api.Net.ApiParamTypes["CreateAppBlockGroup"], "appId" | "blockGroupId" | "orderIndex"> | Pick<Api.Net.ApiParamTypes["CreateAppGroupBlock"], "appGroupId" | "blockId" | "orderIndex"> | Pick<Api.Net.ApiParamTypes["CreateAppGroupBlockGroup"], "appGroupId" | "blockGroupId" | "orderIndex">)[] & {
                clearCached?: boolean;
            };
        };
        GrantAppsAccess: {
            type: ActionType.GRANT_APPS_ACCESS;
            payload: (Pick<Api.Net.ApiParamTypes["GrantAppAccess"], "appId" | "userId" | "appRoleId" | "importId"> | Pick<Api.Net.ApiParamTypes["CreateAppUserGroup"], "appId" | "userGroupId" | "appRoleId"> | Pick<Api.Net.ApiParamTypes["CreateAppGroupUser"], "appGroupId" | "userId" | "appRoleId"> | Pick<Api.Net.ApiParamTypes["CreateAppGroupUserGroup"], "appGroupId" | "userGroupId" | "appRoleId">)[];
        };
        ...
        UpdateUserRoles: {
            ...
            payload: Pick<Api.Net.ApiParamTypes["UpdateUserRole"], "id" | "orgRoleId">[];
        };
        RbacUpdateOrgRole: {
            type: ActionType.RBAC_UPDATE_ORG_ROLE;
            payload: Omit<Api.Net.ApiParamTypes["RbacUpdateOrgRole"], "envs" | "encryptedByTrustChain">;
        };
        RbacUpdateAppRole: {
            type: ActionType.RBAC_UPDATE_APP_ROLE;
            payload: Omit<Api.Net.ApiParamTypes["RbacUpdateAppRole"], "envs" | "encryptedByTrustChain">;
        };
        RbacUpdateEnvironmentRole: {
            type: ActionType.RBAC_UPDATE_ENVIRONMENT_ROLE;
            payload: Omit<Api.Net.ApiParamTypes["RbacUpdateEnvironmentRole"], "envs" | "encryptedByTrustChain">;
        };
        ...
        IncludeAppRoles: {
            ...
            payload: Omit<Api.Net.ApiParamTypes["RbacCreateIncludedAppRole"], "envs" | "encryptedByTrustChain">[];
        };
        ClearLogs: {
        ...
        DeploySelfHosted: {
            ...
            payload: Infra.DeploySelfHostedParams & Omit<Client.PendingSelfHostedDeployment, "type" | "addedAt" | "hostUrl" | "subdomain" | "deploymentTag" | "codebuildLink">;
        };
        ...
        LoadV1Upgrade: {
            ...
            } & Pick<Api.V1Upgrade.Upgrade, "ts" | "signature" | "stripeCustomerId" | "stripeSubscriptionId" | "numUsers" | "signedPresetBilling">;
        };
        LoadV1UpgradeInvite: {
        ...
        StartV1Upgrade: {
            ...
            payload: {
                accountId?: string;
                deviceName?: string;
            } & Omit<ClientActions["ImportOrg"]["payload"], "importCliUsers" | "regenServerKeys" | "importCliUserIds" | "isV1Upgrade"> & Pick<Api.V1Upgrade.Upgrade, "billingInterval" | "ssoEnabled" | "newProductId" | "freeTier">;
        };
        ResetV1Upgrade: {
    ...
    type EnvUpdateAction = EnvUpdateActions[keyof EnvUpdateActions];
    type ClientAction = ClientActions[keyof ClientActions];
}
