...
import { getLatestReleaseVersion } from "@envkey/infra/artifact-helpers";
import { ENVKEY_RELEASES_BUCKET } from "@envkey/infra/stack-constants";
import { log } from "@envkey/core/lib/utils/logger";
import { dialog } from "electron";
import * as sudoPrompt from "@vscode/sudo-prompt";
import * as R from "ramda";
import { version as cliVersion } from "../../client-cli/package.json";
import {
  ELECTRON_BIN_DIR,
