import { parseUserEncryptedKeyOrBlobComposite } from "@envkey/core/lib/blob";
import { pick, stripNullsRecursive } from "@envkey/core/lib/utils/object";
import { getChangesets, getEnvWithMeta } from "@envkey/core/lib/client";
import * as R from "ramda";
import { Client, Api, Model, Crypto, Rbac } from "@envkey/core/types";
import { clientAction, dispatch } from "../handler";
import { statusProducers } from "../lib/status";
import * as g from "@envkey/core/lib/graph";
import {
  encryptSymmetricWithKey,
  decryptSymmetricWithKey,
} from "@envkey/core/lib/crypto/proxy";
import { secureRandomAlphanumeric } from "@envkey/core/lib/crypto/utils";
import { fetchRequiredEnvs } from "@envkey/client-core-process/lib/envs";
import fs from "fs";
import os from "os";
import path from "path";
import { wait } from "@envkey/core/lib/utils/wait";
import { log } from "@envkey/core/lib/utils/logger";
import { updateLocalSocketImportStatusIfNeeded } from "@envkey/client-core-process/lib/envs/status";
import { getAuth } from "@envkey/core/lib/client";
import { getDefaultOrgSettings } from "@envkey/core/lib/client/defaults";
