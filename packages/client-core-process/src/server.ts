import { verifyV1Upgrade } from "@envkey/core/lib/v1_upgrade";
...
import { Client, Crypto } from "@envkey/core/types";
import fkill from "fkill";
import { stop } from "@envkey/core/lib/core_proc";
import {
  hasDeviceKey,
  initDeviceKey,
  initKeyStore,
  ...
  unlock,
  getDeviceKey,
} from "@envkey/core/lib/client_store/key_store";
import { decryptSymmetricWithKey } from "@envkey/core/lib/crypto/proxy";
...
} from "@envkey/core/lib/client_store";
import { log, logStderr, initFileLogger } from "@envkey/core/lib/utils/logger";
import {
  resolveOrgSockets,
  closeAllOrgSockets,
  socketPingLoop,
